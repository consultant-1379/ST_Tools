...
*/  
const std::string LOG_TYPES_MESSAGES[]= {"LOG_ERROR","LOG_WARNING","LOG_EVENT",
				 	"LOG_INFO","LOG_CONNECTIONS","LOG_DEBUG"};            
...
enum log_types
{
	...
	log_event			= 0x00000004,
	log_info			= 0x00000008,
	log_connections 		= 0x00000010,
...
//    void write (char const * line);
    ...
    void set_log_mask(unsigned int log_mask);
    void set_log_mode( unsigned int log_mode);
